...
__turbopack_context__.v(JSON.parse("{\"name\":\"@mcpjam/inspector\",\"version\":\"0.8.2\",\"type\":\"module\",\"description\":\"MCPJam Inspector\",\"license\":\"Apache-2.0\",\"author\":\"MCPJam (https://mcpjam.com)\",\"homepage\":\"https://mcpjam.com\",\"bugs\":\"https://github.com/mcpjam/inspector/issues\",\"bin\":{\"inspector-v1\":\"bin/start.js\"},\"files\":[\"bin\",\"dist\",\"package.json\"],\"scripts\":{\"dev\":\"next dev --turbopack\",\"build\":\"next build\",\"start\":\"next start\",\"lint\":\"next lint\",\"publish\":\"npm publish --access public\",\"publish-all\":\"npm publish --workspaces --access public && npm publish --access public\",\"prettier-fix\":\"prettier --write .\",\"dev:migration\":\"concurrently \\\"npm run migration:server\\\" \\\"npm run migration:client\\\"\",\"migration:server\":\"cd server && npm run dev\",\"migration:client\":\"cd client && npm run dev\",\"build:migration\":\"npm run migration:build:client && npm run migration:build:server\",\"migration:build:client\":\"cd client && npm run build\",\"migration:build:server\":\"cd server && npm run build\",\"start:migration\":\"NODE_ENV=production node dist/server/index.cjs\",\"install:migration\":\"cd server && npm install && cd ../client && npm install\"},\"dependencies\":{\"@ai-sdk/anthropic\":\"^1.2.12\",\"@ai-sdk/openai\":\"^1.3.23\",\"@dnd-kit/core\":\"^6.3.1\",\"@dnd-kit/modifiers\":\"^9.0.0\",\"@dnd-kit/sortable\":\"^10.0.0\",\"@dnd-kit/utilities\":\"^3.2.2\",\"@hookform/resolvers\":\"^3.10.0\",\"@mastra/core\":\"^0.10.6\",\"@mastra/mcp\":\"^0.10.6\",\"@mcpjam/inspector-v1\":\"^0.2.0\",\"@tanstack/react-query\":\"^5.83.0\",\"@tanstack/react-table\":\"^8.21.3\",\"@uiw/react-json-view\":\"^2.0.0-alpha.33\",\"ai\":\"^4.3.19\",\"class-variance-authority\":\"^0.7.1\",\"classnames\":\"^2.5.1\",\"clsx\":\"^2.1.1\",\"cmdk\":\"^1.1.1\",\"date-fns\":\"^3.6.0\",\"embla-carousel-react\":\"^8.6.0\",\"fast-deep-equal\":\"^3.1.3\",\"framer-motion\":\"^12.23.6\",\"input-otp\":\"^1.4.2\",\"lucide-react\":\"^0.525.0\",\"next\":\"15.4.1\",\"next-themes\":\"^0.4.6\",\"ollama-ai-provider\":\"^1.2.0\",\"ollama-ai-provider-v2\":\"^0.0.9\",\"postcss\":\"^8.5.6\",\"radix-ui\":\"^1.4.2\",\"react\":\"19.1.0\",\"react-day-picker\":\"^9.8.0\",\"react-dom\":\"19.1.0\",\"react-hook-form\":\"^7.60.0\",\"react-markdown\":\"^10.1.0\",\"react-resizable-panels\":\"^3.0.3\",\"react18-json-view\":\"^0.2.9\",\"recharts\":\"^2.15.4\",\"remark-gfm\":\"^4.0.1\",\"simple-icons\":\"^15.6.0\",\"sonner\":\"^2.0.6\",\"tailwind-merge\":\"^3.3.1\",\"vaul\":\"^1.1.2\",\"zod\":\"^3.25.76\",\"zod-to-json-schema\":\"^3.24.6\",\"zustand\":\"^5.0.6\"},\"devDependencies\":{\"@eslint/eslintrc\":\"^3\",\"@tailwindcss/postcss\":\"^4.1.11\",\"@types/node\":\"^20\",\"@types/react\":\"^19\",\"@types/react-dom\":\"^19\",\"eslint\":\"^9\",\"eslint-config-next\":\"15.4.1\",\"tailwindcss\":\"^4.1.11\",\"tw-animate-css\":\"^1.3.5\",\"typescript\":\"^5\",\"concurrently\":\"^9.1.0\"},\"workspaces\":[\"server\",\"client\"]}"));}),
...
const APP_CONFIG = {
    ...
    meta: {
        title: "MCPJam",
        description: "MCPJam is a testing and debugging tool for MCP servers. Postman for MCP."
    }
};
}),
...
/* __next_internal_action_entry_do_not_use__ [{"40e1153f1d4dcb3b829e70faae2006eaf66fd78baa":"getValueFromCookie","70345d71fd1c10701d28922d925b0fbadc5ba6d9e9":"getPreference","70562871cada944d8eae278f3f22f800b6dc5b5308":"setValueToCookie"},"",""] */ __turbopack_context__.s({
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getValueFromCookie, "40e1153f1d4dcb3b829e70faae2006eaf66fd78baa", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(setValueToCookie, "70562871cada944d8eae278f3f22f800b6dc5b5308", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getPreference, "70345d71fd1c10701d28922d925b0fbadc5ba6d9e9", null);
}),
...
"[project]/src/types/preferences/theme.ts [app-rsc] (ecmascript)": ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s({
    "THEME_MODE_OPTIONS": ()=>THEME_MODE_OPTIONS,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$preferences$2f$theme$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/types/preferences/theme.ts [app-rsc] (ecmascript)");
;
;
;
;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a4881ca9._.js.map