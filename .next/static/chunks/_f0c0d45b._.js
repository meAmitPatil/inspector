...
;
const createPreferencesStore = (init)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$vanilla$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createStore"])()((set)=>{
        var _init_themeMode, _init_themePreset;
        return {
            themeMode: (_init_themeMode = init === null || init === void 0 ? void 0 : init.themeMode) !== null && _init_themeMode !== void 0 ? _init_themeMode : "light",
            themePreset: (_init_themePreset = init === null || init === void 0 ? void 0 : init.themePreset) !== null && _init_themePreset !== void 0 ? _init_themePreset : "default",
...
const PreferencesStoreProvider = (param)=>{
    let { children, themeMode, themePreset } = param;
    var _storeRef;
    _s();
    ...
    var _current;
    (_current = (_storeRef = storeRef).current) !== null && _current !== void 0 ? _current : _storeRef.current = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$preferences$2f$preferences$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createPreferencesStore"])({
        themeMode,
        themePreset
    });
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(PreferencesStoreContext.Provider, {
...
const usePreferencesStore = (selector)=>{
    _s1();
    const store = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(PreferencesStoreContext);
...
//# sourceMappingURL=_f0c0d45b._.js.map